...
export default function Todo({ task, toggleTasks, removeTask }: TodoProps) {
  ...
  // }
  return (
    <div className="flex items-center bg-slate-100 border-3 my-2 px-3 py-3 rounded-lg hover:shadow-[2px_3px_0_0_black] hover:translate-x-[-2px] hover:translate-y-[-3px] transition-all ease-out transform-gpu cursor-pointer select-none">
